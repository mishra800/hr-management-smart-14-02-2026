...
def create_meeting(
    ...
    try:
        ...
        return meeting_service.create_meeting(meeting, user_id)
...
def get_meetings(
    ...
    user_id = current_user.get("id")
    meetings = meeting_service.get_meetings(user_id, filters)
...
def get_upcoming_meetings(
    ...
    user_id = current_user.get("id")
    return meeting_service.get_upcoming_meetings(user_id, days_ahead)
...
def get_past_meetings(
    ...
    user_id = current_user.get("id")
    return meeting_service.get_past_meetings(user_id, days_back)
...
def get_meeting_analytics(
    ...
    user_id = current_user.get("id")
    return meeting_service.get_meeting_analytics(user_id, date_from, date_to)
...
def check_meeting_conflicts(
    ...
    conflicts = meeting_service.check_conflicts(
        user_id, meeting_date, start_time_obj, end_time_obj, exclude_meeting_id
    )
...
def get_meeting(
    ...
    user_id = current_user.get("id")
    return meeting_service.get_meeting_by_id(meeting_id, user_id)
...
def update_meeting(
    ...
    user_id = current_user.get("id")
    return meeting_service.update_meeting(meeting_id, meeting_update, user_id)
...
def cancel_meeting(
    ...
    """Cancel a meeting"""
    user_id = current_user.get("id")
    meeting = meeting_service.cancel_meeting(meeting_id, user_id, reason)
...
def delete_meeting(
    ...
    meeting = meeting_service.get_meeting_by_id(meeting_id, user_id)
...
def add_attendees(
    ...
    user_id = current_user.get("id")
    meeting_service.add_attendees(meeting_id, attendee_data.user_ids, user_id)
...
def update_attendee_status(
    ...
    meeting_service.update_attendee_status(meeting_id, user_id, status_update.status, requester_id)
...
def mark_attendance(
    ...
    user_id = current_user.get("id")
    meeting_service.mark_attendance(meeting_id, user_id, action)
...
def get_meeting_notes(
    ...
    """Get meeting notes"""
    user_id = current_user.get("id")
    return meeting_service.get_meeting_notes(meeting_id, user_id)
...
def add_meeting_note(
    ...
    return meeting_service.add_meeting_note(
        meeting_id, user_id, note.content, note.note_type, note.is_private
    )
...
def create_action_item(
    ...
    user_id = current_user.get("id")
    return meeting_service.create_action_item(meeting_id, action_item, user_id)
...
def get_my_action_items(
    ...
    user_id = current_user.get("id")
    return meeting_service.get_action_items(assigned_to=user_id, status=status)
...
def update_action_item_status(
    ...
    user_id = current_user.get("id")
    meeting_service.update_action_item_status(action_item_id, status, user_id)
